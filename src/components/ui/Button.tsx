    ...
    return (
      <button
        ...
        className={cn(
          ...
          {
            'bg-fuel-500 text-black hover:bg-fuel-400 shadow-lg shadow-fuel-500/20': variant === 'primary',
            ...
            'border border-fuel-500/30 text-fuel-400 hover:bg-fuel-500/10 hover:border-fuel-500/50': variant === 'outline',
          },
          {
